...
const FORWARDED_RAW_CONTEXT_MESSAGE_LIMIT = 30;
const BOUNDED_LOOP_MAX_STEPS = 2048;
const BOUNDED_LOOP_MAX_DURATION_MS = 21_600_000;
...
export class HttpSessionExecutor implements SessionExecutor {
  ...
  private async runBoundedToolLoop(
    ...
    const boundedLoopMaxDurationMs = attachmentContext.hasChunkedSources ? 21_600_000 : BOUNDED_LOOP_MAX_DURATION_MS;
    ...
    const tools: ExecutorToolDefinition[] = [
      ...
      },
      {
        ...
        spec: {
          ...
          function: {
            name: 'role_home_paths',
            description: 'Return the current role home, attachment home, export home, notes path, and sqlite path for the current role only.',
            parameters: {
              type: 'object',
              properties: {},
              additionalProperties: false,
  ...
  private async buildOpenAIMessages(
    ...
    // 【1.0链路】RAW-CONTEXT-30: 原始对话正文只向上游转发最近 30 条，其余依赖广播板共享记忆和系统提示承接。
